...
<div>
    ...
    <!-- 调用组件进行页面显示 -->
        ...
        <el-row>
            <el-col :span="9">
                <label>构件部品生产企业及其设备生产企业、建设单位</label>
            </el-col>
        </el-row>
        <el-row></el-row>
        <el-row>
            <el-col :span="18">
                <el-form-item label="资质证书编号">
                    <el-input v-model="componentInformation.qualificationNo"></el-input>
                </el-form-item>
            </el-col>
        </el-row>
        <el-row>
            <el-col :span="18">
                <el-form-item label="本单位从事装配式建筑当前累计">
                    <el-input v-model="componentInformation.cumulant"></el-input>
                </el-form-item>
            </el-col>
        </el-row>
    </el-form>
